...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_recipe_other_users_recipe_error(self):
        ...
        new_user = create_user(email='wronguser@example.com', password='test123')
    ...
    def rest_update_recipe_assign_tag(self):
    ...
    def test_create_ingredient_on_update(self):
        """Tests creating ingredient when updating a recipe"""
        recipe = create_recipe(user=self.user)
    ...
    def test_update_recipe_assign_ingredient(self):
        """Tests assigning an existing recipe when updating a recipe."""
    ...
    def test_clear_recipe_ingredients(self):
        """Tests clearing ingredients from a recipe"""
    ...
    def test_filterby_ingredients(self):
        """Test filtering recipes bu ingredients."""
        r1 = create_recipe(user=self.user, title='Ṕosh Beans on Toast')
